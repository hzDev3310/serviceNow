import { AbstractImageMessage } from '@vonage/messages/dist/classes/AbstractImageMessage';
import { MessengerImageParams } from '@vonage/messages/dist/types';
/**
 ...
 * @group Messenger
 */
export declare class MessengerImage extends AbstractImageMessage implements MessengerImageParams {
    /**
     ...
     */
    messenger: import("@vonage/messages/dist/types").MessengerType;
    /**
     ...
     * ```
     */
    constructor(params: MessengerImageParams);
}
