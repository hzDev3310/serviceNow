import { AbstractTextMessage } from '@vonage/messages/dist/classes/AbstractTextMessage';
import { MessengerTextParams, MessengerType } from '@vonage/messages/dist/types';
/**
 * Represents a text message for the Messenger channel.
 *
 * @group Messenger
 */
export declare class MessengerText extends AbstractTextMessage implements MessengerTextParams {
    /**
     ...
     * ```
     */
    constructor(params: MessengerTextParams);
}
