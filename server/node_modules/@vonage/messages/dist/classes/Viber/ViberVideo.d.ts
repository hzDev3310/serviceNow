import { AbstractVideoMessage } from '@vonage/messages/dist/classes/AbstractVideoMessage';
import { ViberVideoParams } from '@vonage/messages/dist/types';
/**
 * Represents a video message for the Viber Service channel.
 *
 * @group Viber
 */
export declare class ViberVideo extends AbstractVideoMessage implements ViberVideoParams {
    channel: 'viber_service';
    viberService: {
        duration: string;
        fileSize: string;
    } & {
        action: import("@vonage/messages/dist/types").ViberAction;
    } & import("@vonage/messages/dist/types").ViberService;
    /**
