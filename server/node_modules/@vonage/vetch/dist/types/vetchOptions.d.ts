import { ContentType, HTTPMethods, ResponseTypes } from '@vonage/vetch/dist/enums';
import { Headers } from '@vonage/vetch/dist/types/headers';
/**
...
export type VetchOptions = {
    ...
    body?: Record<string, string | readonly string[]> | string;
    /**
